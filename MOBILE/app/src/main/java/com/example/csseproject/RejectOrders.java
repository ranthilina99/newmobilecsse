...
public class RejectOrders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reject_orders);

        getSupportActionBar().setTitle("Reject Orders");
        getSupportActionBar().setDefaultDisplayHomeAsUpEnabled(true);

        search=findViewById(R.id.search_reject_orders);
        recyclerView=findViewById(R.id.card_recycleView_reject_orders);
        ...
        firestore.collection("orders").get()
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        orderIViewHolder = new OrderIViewHolder(RejectOrders.this, OrderList);
